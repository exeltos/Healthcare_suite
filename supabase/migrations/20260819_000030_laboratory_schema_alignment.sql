-- Healthcare Suite production schema alignment for laboratory sample governance.
-- Safe/idempotent recovery migration for environments where the ISO 15189
-- laboratory migration was not applied even though the frontend expects it.
begin;
