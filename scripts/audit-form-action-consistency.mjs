...
const sample=read('src/pages/Patients/PatientWorkflowEditors.jsx')
...
const checks=[
 ...
 ['Patient sample editor has footer Cancel + Save',sample.includes("L('Ακύρωση', 'Cancel')")&&sample.includes("L('Αποθήκευση', 'Save')")&&!sample.includes('label={L("Κλείσιμο", "Close")} icon={<X')],
 ['Employee profile edit uses Cancel + Save',employees.includes("L('Ακύρωση', 'Cancel')")&&employees.includes("L('Αποθήκευση', 'Save')")],
