...
const HELP_SEARCH_ALIASES={
  ...
  quality:'ποιοτητα ποιότητα συμβαντα συμβάντα audits audit capa κινδυνοι κίνδυνοι risk quality incidents',
  indicators:'δεικτες δείκτες kpi numerator denominator αριθμητης αριθμητής παρονομαστης παρονομαστής στοχος στόχος provenance indicators metrics',
  notifications:'ειδοποιησεις ειδοποιήσεις alerts escalation κλιμακωση κλιμάκωση critical κρίσιμο αποτελεσμα αποτέλεσμα notifications',
  governance:'governance συμμορφωση συμμόρφωση audit trail retention διατηρηση διατήρηση continuity backup restore privacy gdpr competency',
...
const HELP_PREVIEW_ROUTES={
  ...
  indicators:APP_ROUTES.INDICATORS,
  notifications:APP_ROUTES.STUDIO_GOVERNANCE,
  governance:APP_ROUTES.STUDIO_GOVERNANCE,
