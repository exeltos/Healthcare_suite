...
const KEYS=Object.freeze({incidents:'limoxis_quality_incidents_v1',capa:'limoxis_quality_capa_v1',audits:'limoxis.quality-audits.v1',risks:'limoxis_quality_risks_v1'})
export const qualityRepository=Object.freeze({
  ...
  findRisks:()=>readJsonArray(KEYS.risks,[]), replaceRisks:(rows=[])=>writeJson(KEYS.risks,Array.isArray(rows)?rows:[]),
})
