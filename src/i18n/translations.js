export const translations = {
  el: {
    ...
    login: {
      ...
      welcomeText: 'Συνδεθείτε στο Healthcare Suite για ασφαλή πρόσβαση στην εφαρμογή.', enter: 'Είσοδος στην εφαρμογή →', demoEnter: 'Προβολή Demo', demoHint: 'Δοκιμαστικό περιβάλλον με ενδεικτικά δεδομένα', demoUser: 'Χρήστης Demo', support: 'Τεχνική υποστήριξη',
      ...
      signInTitle: 'Σύνδεση χρήστη', signInText: 'Εισαγάγετε τα προσωπικά σας στοιχεία για ασφαλή πρόσβαση.', username: 'Όνομα χρήστη', email: 'Email', password: 'Κωδικός πρόσβασης', signIn: 'Σύνδεση',
      missingCredentials: 'Συμπληρώστε όνομα χρήστη και κωδικό πρόσβασης.', invalidCredentials: 'Δεν ήταν δυνατή η σύνδεση.', productionAuthRequired: 'Η παραγωγική ταυτοποίηση δεν έχει ακόμη συνδεθεί. Ελέγξτε τη ρύθμιση Supabase.', productionEmailRequired: 'Στο Production mode η σύνδεση γίνεται με το email του λογαριασμού.', recoverySentProduction: 'Εστάλη email επαναφοράς κωδικού, εφόσον ο λογαριασμός είναι έγκυρος.', recoveryRateLimit: 'Έχουν γίνει πολλές προσπάθειες ανάκτησης κωδικού. Παρακαλώ περιμένετε λίγο και δοκιμάστε ξανά.', demoDisabledProduction: 'Η είσοδος Demo είναι απενεργοποιημένη σε Production mode.', productionMode: 'Production mode — απαιτείται πραγματική ταυτοποίηση', demoMode: 'Demo mode — τοπικό περιβάλλον δοκιμών', productionRecoveryRequired: 'Η ανάκτηση κωδικού απαιτεί σύνδεση με την παραγωγική υπηρεσία ταυτοποίησης.', recoverySentDemo: 'Demo mode: καταγράφηκε δοκιμαστικό αίτημα ανάκτησης.', forgotPassword: 'Ξέχασα τον κωδικό', forgotTitle: 'Ανάκτηση κωδικού', forgotText: 'Εισαγάγετε το email ή το όνομα χρήστη σας. Θα σταλούν οδηγίες ανάκτησης όταν συνδεθεί η υπηρεσία ταυτοποίησης.', sendRecovery: 'Αποστολή οδηγιών', recoverySent: 'Αν ο λογαριασμός υπάρχει, θα λάβετε οδηγίες ανάκτησης.', showPassword: 'Εμφάνιση κωδικού', hidePassword: 'Απόκρυψη κωδικού',
    },
    dashboard: {
    ...
    nav: {
      ...
      promotedAntibiotics: 'Προωθημένα Αντιβιοτικά', antimicrobialSurveillance: 'Αντιμικροβιακή Επιτήρηση', antimicrobialConsumption: 'Κατανάλωση Αντιμικροβιακών', quality: 'Κέντρο Ποιότητας', committees: 'Επιτροπές', training: 'Εκπαίδευση', documents: 'Έγγραφα', lira: 'LIRA AI', studio: 'Κέντρο Διαχείρισης',
    },
  },
  en: {
    common: {
    ...
    login: {
      ...
      secureEnvironment: 'Secure Healthcare Environment', yes: 'Yes', no: 'No', select: 'Select', welcome: 'Welcome', welcomeText: 'Sign in to Healthcare Suite for secure access to the application.', enter: 'Enter application →', demoEnter: 'View Demo', demoHint: 'Sample environment with demonstration data', demoUser: 'Demo User', support: 'Technical support',
      ...
      username: 'Username', email: 'Email', password: 'Password', signIn: 'Sign in', missingCredentials: 'Enter your username and password.', invalidCredentials: 'Sign in was not successful.', productionAuthRequired: 'Production authentication is not connected yet. Check the Supabase configuration.', productionEmailRequired: 'Production mode signs in with the account email address.', recoverySentProduction: 'A password recovery email was sent if the account is valid.', recoveryRateLimit: 'Too many password recovery attempts have been made. Please wait a little and try again.', demoDisabledProduction: 'Demo access is disabled in Production mode.', productionMode: 'Production mode — real authentication required', demoMode: 'Demo mode — local test environment', productionRecoveryRequired: 'Password recovery requires the production authentication service.', recoverySentDemo: 'Demo mode: a test recovery request was recorded.', forgotPassword: 'Forgot password?', forgotTitle: 'Password recovery', forgotText: 'Enter your email or username. Recovery instructions will be sent when the authentication service is connected.', sendRecovery: 'Send instructions', recoverySent: 'If the account exists, recovery instructions will be sent.', showPassword: 'Show password', hidePassword: 'Hide password',
    },
    dashboard: {
    ...
    nav: {
      ...
      promotedAntibiotics: 'Restricted Antibiotics', antimicrobialSurveillance: 'Antimicrobial Surveillance', antimicrobialConsumption: 'Antimicrobial Consumption', quality: 'Quality Hub', committees: 'Committees', training: 'Training', documents: 'Documents', lira: 'LIRA AI', studio: 'Administration Center',
    },
  },
}
