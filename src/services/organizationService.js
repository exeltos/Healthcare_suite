...
export const loadCommittees=()=>organizationRepository.findCommittees(seedCommittees).map(x=>({...x,memberIds:x.memberIds||[],members:x.members||[],agenda:x.agenda||[],meetings:x.meetings||[],attachments:x.attachments||[]}))
